...
public class ItemMasterModel {
	...
	@Resource
	private UserDefinedFieldsDAO userDefinedFieldsDAO;

	public Boolean insertItemMasterDetails(Map<String, Object> internalmap, Boolean finishOrRaw) {
		...
		bo.setFinishOrRaw(Conversion.toBoolean(finishOrRaw));
	...
	public Boolean insertItemMasterDetailsRawMaterial(Map<String, Object> internalmap, Boolean finishOrRaw) {
	...
	public Map<String, Object> getItemMasterExcellDownload() {
		...
		List<UserDefinedFieldsBO> listUserDefinedFieldsBO = userDefinedFieldsDAO.displayUserDefinedFields(true);
		...
		for (Map<String, Object> internalmap : databasevalue) {
			...
			listUserDefinedFieldsBO.forEach(userDefinedFieldsBO -> {
				finalmap.put(userDefinedFieldsBO.getColumnName(), internalmap.get(userDefinedFieldsBO.getuDF()));
			});
		...
		listUserDefinedFieldsBO.forEach(userDefinedFieldsBO -> {
			dataType.put(userDefinedFieldsBO.getColumnName(), "String");
		});

...
public class ItemMasterController {
	...
	public @ResponseBody Boolean insertItemMasterDetails(@RequestBody Map<String, Map<String,Object>> itemMasterBO,
		...
		if (Conversion.toBoolean(mapOfFinishOrRaw.get("finishOrRaw"))) {
			return itemMasterModel.insertItemMasterDetails(mapOfItemMasterBO,Conversion.toBoolean(mapOfFinishOrRaw.get("finishOrRaw")));

		} else {
			return itemMasterModel.insertItemMasterDetailsRawMaterial(mapOfItemMasterBO,Conversion.toBoolean(mapOfFinishOrRaw.get("finishOrRaw")));
